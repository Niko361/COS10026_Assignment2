...
<body>
  ...
  //checks that the username and password has been set
  if(($username == "") || ($password == ""))
  {
      echo "<p><b>Username and/or password empty, go back to the login portal <a href=\"manageattemptslogin.php\">here</a></b></p>";
  }  
  else if(!$result) //returns error if the query was unsuccesful
  {
    echo "<p>Something is wrong with ", $query, "</p>";
  } 
  else if(!(mysqli_fetch_assoc($result)["password"] == $password))
  {
